    ...
    <Box sx={{ maxWidth: 860, mx: 'auto' }}>
      ...
      <GlassCard>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
          ...
          <GlowButton onClick={() => setCreateDialog(true)}>
            {t('admin.createUser')}
          </GlowButton>
        </Box>
      ...
      <Dialog open={createDialog} onClose={() => setCreateDialog(false)}>
        ...
        <DialogActions>
          ...
          <GlowButton onClick={handleCreateUser}>{t('admin.save')}</GlowButton>
        </DialogActions>
      </Dialog>
      ...
      <Dialog open={editDialog.open} onClose={() => setEditDialog({ open: false, user: null })}>
        ...
        <DialogActions>
          ...
          <GlowButton onClick={handleSaveUser}>{t('admin.save')}</GlowButton>
        </DialogActions>
      </Dialog>
      ...
      <Dialog open={passwordDialog.open} onClose={() => setPasswordDialog({ open: false, user: null })}>
        ...
        <DialogActions>
          ...
          <GlowButton onClick={handleSavePassword}>{t('admin.save')}</GlowButton>
        </DialogActions>
      </Dialog>
    </Box>
  );
